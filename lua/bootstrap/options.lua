...
vim.opt.swapfile = false -- Desactiva el uso de archivos swap
vim.opt.backup = false -- Desactiva el archivo de respaldo
vim.opt.writebackup = false -- Desactiva la creación de respaldos antes de sobrescribir
