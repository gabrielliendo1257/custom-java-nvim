...
local function get_jdtls()
	local jdtls_os = require("mini.plugins.os.jdtls-os")
...
local function get_bundles()
	...
	local jdtls_path = "C:\\Users\\guillermo\\AppData\\Local\\nvim-data\\mason\\packages\\jdtls"
...
local lspconfig_commons = require("mini.plugins.config.lsp-commons")
